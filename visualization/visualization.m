...
% Inpu a pose you want to see
pose_input = [-0.16367666776497108 -0.6596727518850166 423.72335568362746 -7.069073827644413 7.809277820024048 -7.584001227298295]; % [X Y Z ]
pose_input(:, 4:6) = deg2rad(pose_input(:, 4:6));
